...
export default function Home() {
  return (
    <div>
      ...
      {/* CTA Section */}
      <section className="cta-section w-full px-4 md:px-6">
        <div className="cta-container mx-auto py-32 text-center rounded-2xl">
          <h2 className="cta-title text-4xl md:text-5xl font-bold mb-4">
            Ready to Accelerate Your Career?
          </h2>

          <p className="cta-text text-lg md:text-xl max-w-2xl mx-auto mb-8">
            Join thousands of professionals who are advancing their careers with AI-powered guidance.
          </p>

          <Link href="/dashboard">
            <button className="cta-button inline-flex items-center px-8 py-3 rounded-lg text-lg font-medium shadow-md">
