  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="space-y-2">
        <h1 className="text-4xl font-bold gradient-title">Video Interview Prep</h1>
        <p className="text-muted-foreground">
          Practice face-to-face questions with real-time AI feedback on your answers.
        </p>
      </div>
