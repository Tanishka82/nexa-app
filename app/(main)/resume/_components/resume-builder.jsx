...
export default function ResumeBuilder({ initialContent }) {
  ...
  // ✅ FIX: Prevent rendering until user is loaded
  if (!isLoaded) {
    return (
  ...
  const handleAiImprovement = async (fieldName, type) => {
    const currentValue = watch(fieldName);
    if (!currentValue) {
      toast.error("Please enter some text first to improve.");
      return;
    }
    ...
    try {
      ...
      setValue(fieldName, improvedContent);
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: `Resume - ${user?.fullName || ""}`, // ✅ FIX: Optional chaining safety
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <Button
                  ...
                  onClick={() =>
                    handleAiImprovement("summary", "professional summary")
                  }
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <Button
                  ...
                  size="sm"
                  className="gap-2 border-primary text-primary hover:bg-primary hover:text-white transition-colors"
                  onClick={() => handleAiImprovement("skills", "skills list")}
                  disabled={isAiLoading}
                >
                  <Sparkles className="h-4 w-4" />
                  Auto-Improve
